...
- **Editor Tabs**: the "+ new query" entry lives at the end of the tab bar (browser-style), with Cmd/Ctrl+T to open a new query tab and Cmd/Ctrl+W to close the active one
